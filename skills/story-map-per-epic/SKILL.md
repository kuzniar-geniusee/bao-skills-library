...
description: "Build a Miro-importable xlsx story map for one epic from the approved output of decompose-wbs-epic. Lays the WBS parent stories left-to-right as the backbone and stacks their decomposed child stories beneath each. Arranges only the approved stories — never invents. Trigger: 'story map', 'make the story map for an epic', 'prepare the stories for Miro' after a decomposition is approved."
---
